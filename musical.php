...
<body>
  ...
  <div class="container">
    ...
    <br><br>
    <div class="row">
      <div class="col-md-12 ten-padding paragraph-border" align="center">
        <br>
        <h3 >Details </h3>

        <p class="ten-padding">
        We will be meeting every Sunday in January and February, directly after Sunday School. Communion will be brought down to the children and then the children will be dismissed when church lets out. Those wanting a singing role will stay until noon so we have some extra time to rehearse the music.
          <br><br>
          <b>Questions?</b>
          <br>
  ...
  document.addEventListener('DOMContentLoaded', function() {
    if (mobileAndTabletcheck() == false) {
      var img1 = document.getElementById("img-flipable1");
      var img2 = document.getElementById("img-flipable2");
      var img3 = document.getElementById("img-flipable3");
      img1.className += " rotate90";
      img2.className += " rotate90";
      img3.className += " rotate90";
    }
  }, false);
  </script>
