...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12" align="center">
        <div class="btn-group">
          <a href="#youth" class="btn btn-outline-primary">Youth</a>
          <a href="#music" class="btn btn-outline-primary">Choirs & Music</a>
          <a href="#outreach" class="btn btn-outline-primary">Outreach</a>
          <a href="#fellowship" class="btn btn-outline-primary">Fellowship</a>
        </div>
      </div>
    </div>
    <br>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12" align="center">
          <a class="anchor" id="youth"></a>
          <h2 id="youth" class="page-header">Youth</h2>
        </div>
      </div>
      ...
      <div class="card-deck">
        ...
        <div class="card">
          <div class="card-body" align="center">
            ...
            <img src="images/vestry/missing.jpg" class="img-fluid" alt=" photo" title="">
            <p>Jubilation Choir is open to boys and girls in kindergarten through high school. The choir performs on Youth Sundays and special services during the program year. The choir rehearses after the 10:00 am service from 11:15 am to noon in the choir room. Jubilation Choir also invites those interested to learn to play our set of hand chimes and other instruments while developing musicianship skills.</p>
          </div>
    ...
    <div class="card-deck">
      ...
      <div class="card">
        <div class="card-body" align="center">
          <h2 class="cardtop">To Be Added</h2>
          <img src="images/vestry/missing.jpg" class="img-fluid" alt=" photo" title="">
          <p>Empty card</p>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12" align="center">
          <a class="anchor" id="fellowship"></a>
