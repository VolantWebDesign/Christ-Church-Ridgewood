					...
					<div class="card-body">
						...
						<div class="col-md-6">
							...
							<table class="table table-striped table-sm">
								...
								<tr>
									<td align="right" ><strong>9:15 AM </td>
				...
				<div class="col-md-6">
					<div class="card card-default">
						...
						<h3>Event Canceled</h3>
							...
							<img src="documents/ccfalldance2017vlarge.png" alt="The Rainbow Room, Dinner and Dancing" title="The Rainbow Room, Dinner and Dancing" class="img-fluid">
							<br>

						</div>
						<div class="card-footer" align="center">
							For more information, contact Al Pucciarelli at <a href="mailto:apucciarelli@mdmc-law.com">apucciarelli@mdmc-law.com</a>
						</div>
					</div>
				</div>
...
<!-- Juicer -->
			<div class="row">
				<div class="container">
					...
					<ul class="juicer-feed" data-feed-id="christridgewood" data-per="15"><h1 class="referral"><a href="https://www.juicer.io">Powered by Juicer</a></h1></ul>
				</div>
			</div>
